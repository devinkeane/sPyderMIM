...
o---O   High Performance Computing Genomic Network Analysis    |  Version 5.3  |    ✧ - ･ﾟ*
O---o                               +------------------------------------------+ 
...
print('', file= summary_file)
print('Total Nodes:  '+G.number_of_nodes(), file= summary_file)
print('Total Edges:  '+G.number_of_edges(), file= summary_file)
print('', file= summary_file)
